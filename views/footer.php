...
<ul class="list-reset flex bg-grey-lightest pin-b sticky">
	...
	<li class="flex">
		<a class="text-2xl text-center block font-semibold text-teal-light bg-grey-lighter hover:bg-teal-darker py-4 px-4 no-underline" href="/../app/users/profile.php"><i class="fas fa-user-circle"></i></a>
	</li>
	<li class="flex">
	<a class="text-2xl text-center block font-semibold text-teal-light bg-grey-lighter hover:bg-teal-darker py-4 px-4 no-underline" href="/views/settings-view.php"><i class="fas fa-cog"></i></a>
	</li>
</ul>
<?php endif; ?>
