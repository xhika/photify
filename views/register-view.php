...
<div class="bg-grey-lighter p-6 h-screen">
	<form method="post" class="text-center" action="/app/users/register.php">
		...
		<input type="text" name="lastname" class="bg-grey-light rounded py-2 border-solid border-black my-2">
		...
		<input type="text" name="username" class="bg-grey-light rounded py-2 border-solid border-black my-2">
