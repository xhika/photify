...
<div class="bg-grey-lighter p-6 w-full md:w-3/5 mx-auto p-4 rounded h-screen">
	<form method="post" class="text-center" action="/views/update-view.php">
		...
		<input type="email" name="email" class="bg-grey-light rounded py-2 border-solid border-black my-2 focus:bg-white">
		<label for="bio" class="block font-bold uppercase tracking-wide">bio:</label>
		<input type="text" name="bio" class="bg-grey-light rounded py-2 border-solid border-black my-2 focus:bg-white">
